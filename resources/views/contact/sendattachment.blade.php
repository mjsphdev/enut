							...
							<table border="0" cellpadding="0" cellspacing="0" width="100%">
								...
								<tr>
									<td
										...
										<p>Providing you the requested dataset and data dictionary in CSV format.</p>
										<p>To help us improve our services, may we request you to fill up the attached
											feedback form and send it to enutrition.dostfnri@gmail.com</p>
										<p>Sincerely yours,<br>
											Nutrition Statistics and Informatics Section<br>
											Nutritional Assessment and Monitoring Division<br>
											DOST-FNRI</p>
									</td>
								</tr>
								<tr>
